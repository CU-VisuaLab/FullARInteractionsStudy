...
{ 
    ...
    /// </summary>
    public abstract class WiimoteBaseInputSource : MonoBehaviour, IInputSource
    {
        ...
        {
            if (!isRegistered && WiimoteInputManager.Instance != null)
            {
                WiimoteInputManager.Instance.RegisterInputSource(this);
                isRegistered = true;
            }
        }
        ...
        private void UnregisterFromInputManager()
        {
            if (isRegistered)
            {
                WiimoteInputManager.Instance.UnregisterInputSource(this);
                isRegistered = false;
            }
        }
