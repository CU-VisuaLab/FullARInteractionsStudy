...
namespace HoloToolkit.Unity.InputModule
{
    ...
    {
        // GazeManager augmentation for logging
        public bool logging;
            ...
            if (logging)
            {
                ...
                if (HitObject != null)
                {
                    ...
                    else if (HitObject.GetComponent<RectTransform>() != null)
                    {
                        ...
                        float scale = HitObject.GetComponent<RectTransform>().localScale.x;
                        if (HitObject.name == "StartStopButton") // TODO: Wonky way of dealing with start/stop button
                        {
                            xOff = -2f;
                            yOff = 1f;
                        }
                        Debug.Log("Gaze: " + HitObject.name + HitObject.GetComponent<RectTransform>().rect.size * scale +
