...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    public class WiimoteInputManager : Singleton<WiimoteInputManager>
    {
        ...
        /// </summary>
        public bool ShouldSendUnityUiEvents { get { return WiimoteGazeManager.Instance.UnityUIPointerEvent != null && EventSystem.current != null; } }
        ...
        private void Start()
        {
            ...
            if (WiimoteGazeManager.Instance == null)
            {
            ...
            where T : IEventSystemHandler
        {
            ...
            if (modalInputStack.Count > 0)
            {
                ...
                // bubble there
                GameObject focusedObject = WiimoteGazeManager.Instance.HitObject;
            ...
            {
                bool eventHandled = ExecuteEvents.ExecuteHierarchy(WiimoteGazeManager.Instance.HitObject, eventData, eventHandler);
                if (eventHandled)
                {
                    return;
                }
        ...
        {
            if (!isRegisteredToGazeChanges && WiimoteGazeManager.Instance != null)
            {
                WiimoteGazeManager.Instance.FocusedObjectChanged += GazeManager_FocusedChanged;
        ...
        private void GazeManager_FocusedChanged(GameObject previousObject, GameObject newObject)
        {
            ...
            if (previousObject != null)
            {
                ...
                {
                    ExecuteEvents.ExecuteHierarchy(previousObject, WiimoteGazeManager.Instance.UnityUIPointerEvent, ExecuteEvents.pointerExitHandler);
                }
            }
            ...
            if (newObject != null)
            {
                ...
                if (ShouldSendUnityUiEvents)
                {
                    ExecuteEvents.ExecuteHierarchy(newObject, WiimoteGazeManager.Instance.UnityUIPointerEvent, ExecuteEvents.pointerEnterHandler);
                }
            }
        }
        ...
        private void InputSource_SourceClicked(object sender, SourceClickEventArgs e)
        {
            ...
            if (ShouldSendUnityUiEvents)
            {
                PointerEventData unityUIPointerEvent = WiimoteGazeManager.Instance.UnityUIPointerEvent;
