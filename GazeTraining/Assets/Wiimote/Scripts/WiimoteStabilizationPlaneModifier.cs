...
namespace HoloToolkit.Unity
{
    ...
    /// </summary>
    public class WiimoteStabilizationPlaneModifier : Singleton<WiimoteStabilizationPlaneModifier>
    {
        ...
        [Tooltip("Use the WiimoteGazeManager class to set the plane to the gazed upon hologram. If disabled, the plane will always be at a constant distance.")]
        ...
        private WiimoteGazeManager gazeManager;

        private void Start()
        {
            gazeManager = WiimoteGazeManager.Instance;
        }
        ...
        {
            Vector3 gazeOrigin = WiimoteGazeManager.Instance.GazeOrigin;
            Vector3 gazeDirection = WiimoteGazeManager.Instance.GazeNormal;
            ...
            {
                focusPointDistance = (gazeManager.GazeOrigin - WiimoteGazeManager.Instance.HitPosition).magnitude;
            }
            else
            {
